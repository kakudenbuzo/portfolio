...
export const translations = {
  en: {
    ...
    summary:
      "Web Application Engineer with 5+ years of experience building full-stack systems in TypeScript, Java, and Dart. At Commune, I work across community SaaS feature development and in-house shared infrastructure — including designing an OAuth2.0 / OIDC authentication platform and a cross-product API authorization layer from scratch. Passionate about crafting products that solve real user problems, demonstrated by a boxing scorecard app with 10,000+ downloads. Google Professional Cloud Architect certified.",
    contact: {
  ...
  ja: {
    ...
    summary:
      "TypeScript・Java・Dartを用いたフルスタック開発に5年以上携わるWebアプリケーションエンジニアです。現在は株式会社CommuneにてコミュニティSaaSの機能開発に加え、OAuth2.0 / OIDCを用いた共通認証基盤やプロダクト間API連携基盤をゼロから設計・開発しています。自ら開発したボクシング採点アプリは累計10,000件以上のダウンロードを達成。Google Professional Cloud Architect認定取得済み。",
    contact: {
      location: "東京都",
      email: "musashi.t.app@gmail.com",
    },
